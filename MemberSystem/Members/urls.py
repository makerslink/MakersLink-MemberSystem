...
urlpatterns = [
    ...
    path('password/reset/confirm', auth_views.PasswordResetConfirmView.as_view(template_name="registration/reset_password_confirm.html", success_url=reverse_lazy('Members:password_change_done')), name='password_reset_confirm'),
]
